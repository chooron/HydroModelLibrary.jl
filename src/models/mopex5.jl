...
model_variables = [Sn, S1, S2, Sc1, Sc2, P, T, Ep, Ps, Qn, dd, Pr, ET1, Q1f, Qw, ET2, Q2u, Q2f, Qu, Qf, Qt, GSI, I, Q1f, Qw, Q2u, Q2f, Qf, Qu, Qt]
# Model parameters
...
model_parameters = [tcrit, ddf, sb1, tw, i_alpha, i_s, tmin, trange, tu, se, sb2, tc]
tmax = tmin + trange
