...
model_variables = [UZTW, Peff, Ru, Euztw, Twexu, P, Qdir, UZFW, Ep, Euzfw, Qsur, Qint, Pc, Pcdemand, LZdeficiency, LZcapacity, Rprop1, Rprop2, Rprop3, LZTW, LZFWP, LZFWS, Rlp, Rls, Elztw, Twexl, Qbfp, Qbfs, Qt]
# Model parameters
...
model_parameters = [PCTIM, UZTWM, kuz, REXP, PFREE, klzp, klzs, Smax, f1, f2, f3, f4]
