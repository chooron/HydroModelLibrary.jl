...
model_variables = [S, Ps, M, T, P, U, Pr, Eu, If, Pn, Ep, L, Dl, Et, Of, O, Qo, I, Qi, G, Gw, Qb, Qt]
# Model parameters
...
model_parameters = [Cs, Cif, stot, fl, CL1, Cof, CL2, K0, K1, Kb]
...
bucket2 = @hydrobucket :bucket2 begin
    fluxes = begin
        ...
        @hydroflux Of ~ min(L, Cof * clamp((L / Lmax - CL2) / (1 - CL2), 0.0, 1.0) * Pn)
