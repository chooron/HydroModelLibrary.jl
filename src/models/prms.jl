...
model_variables = [Sn, Ps, M, P, T, XIN, Pin, Ein, Ptf, Psm, Pr, Ep, Rstor, Pim, Mim, SAS, RECHR, INF, Ea, Pc, Msm, Pby, SRO, Eim, SMAV, Et, EXCS, RES, QRES, GAD, RAS, SEP, GW, BAS, SNK, Qt]
# Model parameters
...
@parameters stor [description = "Maximum interception storage", bounds = (0, 50), unit = "mm"]
@parameters retip [description = "Maximum depression storage", bounds = (0, 200), unit = "mm"]
...
model_parameters = [tt, ddf, alpha, beta, stor, retip, fscn, scx, flz, stot, cgw, resmax, k1, k2, k3, k4, k5, k6]
...
bucket3 = @hydrobucket :bucket3 begin
    fluxes = begin
        ...
        @hydroflux SAS ~ min(max(0.0, Rstor - retip), (Pim + Mim))
    end
    dfluxes = begin
