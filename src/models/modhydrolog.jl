...
model_variables = [I, P, Ei, EXC, Ep, SMS, SMSProp, SMF, DINF, INF, INT, REC, ET, GWF, RUN, SRUN, RATE, TRAP, ED, SEEP, FLOW, Qt, DH, GW, CH]
# Model parameters
...
model_parameters = [INSC, COEFF, SQ, SMSC, SUB, CRAK, EM, DSC, ADS, MD, VCOND, DLEV, k1, k2, k3]
# Soil water component
bucket_1 = @hydrobucket :bucket_1 begin
    fluxes = begin
        @hydroflux Ei ~ min(max(I, 0.0), Ep)
