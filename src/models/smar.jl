...
model_variables = [S1, I, P, Ep, Pe, R1, R2, E1, q1, EPe, S2, E2, q2, S3, E3, q3, S4, E4, q4, S5, E5, R3, Gw, Rg, Qg, Qr, Qt]
# Model parameters
...
model_parameters = [H, Y, Smax, C, G, KG, N, K]
